    ...
    <div className="bg-[#F7F7F7] min-h-screen font-['Poppins'] py-12 px-4 md:px-8">
      <div className="max-w-[900px] mx-auto bg-white rounded-[20px] shadow-sm border border-[#EDEDED] overflow-hidden">
        ...
        <div className="bg-[#212121] p-10 md:p-16 text-center">
          <FaFileSignature className="text-[#BA7786] text-4xl mx-auto mb-6 opacity-80" />
          <h1 className="text-white text-[28px] md:text-[40px] font-bold uppercase tracking-[0.2em] mb-4">
            Terms of <span className="text-[#BA7786]">Service</span>
          </h1>
        ...
        <div className="p-8 md:p-16 border-b border-[#EDEDED] bg-[#FAFAFA]">
          <p className="text-[#454545] text-center italic text-[15px] leading-relaxed">
            "By accessing or using the MAESHA platform, you agree to be bound by these terms. 
        ...
        <div className="p-8 md:p-16 space-y-12 text-[#454545] leading-relaxed text-[15px]">
          ...
          <section className="group">
            <h2 className="text-[#212121] text-[18px] font-bold uppercase tracking-wider mb-6 flex items-center gap-4">
              <FaShoppingCart className="text-[#BA7786]" /> 1. Accounts & Eligibility
            </h2>
            <div className="pl-8 space-y-4 text-[#787878] border-l-2 border-[#EDEDED] group-hover:border-[#BA7786] transition-colors">
              ...
              <p>MAESHA reserves the right to refuse service or terminate accounts at our sole discretion.</p>
            </div>
          </section>

          <section className="group">
            <h2 className="text-[#212121] text-[18px] font-bold uppercase tracking-wider mb-6 flex items-center gap-4">
              <FaTruck className="text-[#BA7786]" /> 2. Orders & Shipping
            </h2>
            <div className="pl-8 space-y-4 text-[#787878] border-l-2 border-[#EDEDED] group-hover:border-[#BA7786] transition-colors">
          ...
          <section className="group">
            <h2 className="text-[#212121] text-[18px] font-bold uppercase tracking-wider mb-6 flex items-center gap-4">
              <FaUndoAlt className="text-[#BA7786]" /> 3. Returns & Refunds
            </h2>
            <div className="pl-8 space-y-4 text-[#787878] border-l-2 border-[#EDEDED] group-hover:border-[#BA7786] transition-colors">
          ...
          <section className="group">
            <h2 className="text-[#212121] text-[18px] font-bold uppercase tracking-wider mb-6 flex items-center gap-4">
              <FaBalanceScale className="text-[#BA7786]" /> 4. Intellectual Property
            </h2>
            <div className="pl-8 space-y-4 text-[#787878] border-l-2 border-[#EDEDED] group-hover:border-[#BA7786] transition-colors">
          ...
          <div className="bg-[#212121] text-white p-8 rounded-[15px] shadow-xl mt-12">
            <h3 className="text-[#BA7786] font-bold uppercase text-[14px] tracking-[0.2em] mb-4">
